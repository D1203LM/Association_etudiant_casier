...
def cacher_labels_erreur(objet):
    ...
    objet.label_erreur_casier_non_disponible.setVisible(False)
...
class fenetrePrincipale(QtWidgets.QMainWindow, interfacegraphique.Ui_MainWindow):
    ...
    def on_pushButton_ajouter_clicked(self):
        ...
        # Si le numéro du casier est valide mais existe déjà dans la liste des étudiants (on ne peut donc pas l'ajouter)
        if verifier_casier is True :
            # Effacer le lineEdit du numéro casier et afficher le message d'erreur
            self.lineEdit_numero_casier.clear()
            self.label_erreur_casier_non_disponible.setVisible(True)
