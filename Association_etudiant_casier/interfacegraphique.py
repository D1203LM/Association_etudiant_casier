...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1112, 1129)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.pushButton_ajouter = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_ajouter.setGeometry(QtCore.QRect(160, 640, 151, 51))
        font = QtGui.QFont()
        ...
        self.textBrowser_afficher.setGeometry(QtCore.QRect(160, 900, 841, 171))
        ...
        self.pushButton_supprimer.setGeometry(QtCore.QRect(820, 640, 151, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.pushButton_modifier.setGeometry(QtCore.QRect(500, 640, 151, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_programme.setGeometry(QtCore.QRect(680, 150, 271, 41))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(20)
        font.setBold(True)
        ...
        self.comboBox_programme.setGeometry(QtCore.QRect(680, 200, 291, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.pushButton_sauvegarder.setGeometry(QtCore.QRect(160, 720, 151, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.pushButton_afficher_listview.setGeometry(QtCore.QRect(820, 720, 151, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.pushButton_serealiser.setGeometry(QtCore.QRect(500, 720, 151, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_erreur_fichier.setGeometry(QtCore.QRect(460, 860, 271, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_taille_casier = QtWidgets.QLabel(self.centralwidget)
        self.label_taille_casier.setGeometry(QtCore.QRect(680, 380, 271, 31))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(20)
        font.setBold(True)
        font.setItalic(True)
        font.setWeight(75)
        self.label_taille_casier.setFont(font)
        self.label_taille_casier.setObjectName("label_taille_casier")
        self.label_loaclisation_casier = QtWidgets.QLabel(self.centralwidget)
        self.label_loaclisation_casier.setGeometry(QtCore.QRect(680, 500, 271, 31))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(20)
        font.setBold(True)
        font.setItalic(True)
        font.setWeight(75)
        self.label_loaclisation_casier.setFont(font)
        self.label_loaclisation_casier.setObjectName("label_loaclisation_casier")
        self.label_numero_casier = QtWidgets.QLabel(self.centralwidget)
        self.label_numero_casier.setGeometry(QtCore.QRect(160, 360, 271, 31))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(20)
        font.setBold(True)
        ...
        self.comboBox_localisation_casier = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox_localisation_casier.setGeometry(QtCore.QRect(680, 550, 291, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.comboBox_localisation_casier.setFont(font)
        self.comboBox_localisation_casier.setObjectName("comboBox_localisation_casier")
        self.comboBox_localisation_casier.addItem("")
        self.comboBox_localisation_casier.addItem("")
        self.comboBox_localisation_casier.addItem("")
        self.lineEdit_numero_casier = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_numero_casier.setGeometry(QtCore.QRect(160, 410, 281, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setItalic(True)
        self.lineEdit_numero_casier.setFont(font)
        self.lineEdit_numero_casier.setObjectName("lineEdit_numero_casier")
        self.comboBox_taille_casier = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox_taille_casier.setGeometry(QtCore.QRect(680, 430, 291, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.comboBox_taille_casier.setFont(font)
        self.comboBox_taille_casier.setObjectName("comboBox_taille_casier")
        self.comboBox_taille_casier.addItem("")
        self.comboBox_taille_casier.addItem("")
        self.comboBox_taille_casier.addItem("")
        self.label_erreur_casier_non_disponible = QtWidgets.QLabel(self.centralwidget)
        self.label_erreur_casier_non_disponible.setGeometry(QtCore.QRect(160, 460, 401, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_erreur_casier_non_disponible.setFont(font)
        self.label_erreur_casier_non_disponible.setObjectName("label_erreur_casier_non_disponible")
        self.label_erreur_numero_casier = QtWidgets.QLabel(self.centralwidget)
        self.label_erreur_numero_casier.setEnabled(True)
        self.label_erreur_numero_casier.setGeometry(QtCore.QRect(160, 480, 441, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.pushButton_cours = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_cours.setGeometry(QtCore.QRect(160, 800, 151, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.pushButton_cours.setFont(font)
        self.pushButton_cours.setObjectName("pushButton_cours")
        self.label_local = QtWidgets.QLabel(self.centralwidget)
        self.label_local.setGeometry(QtCore.QRect(680, 260, 271, 41))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(20)
        font.setBold(True)
        ...
        self.comboBox_local.setGeometry(QtCore.QRect(680, 310, 291, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.comboBox_local.setFont(font)
        self.comboBox_local.setObjectName("comboBox_local")
        self.pushButton_ajouter_local = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_ajouter_local.setGeometry(QtCore.QRect(500, 800, 151, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.pushButton_ajouter_local.setFont(font)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_taille_casier.setText(_translate("MainWindow", "Taille du casier"))
        self.label_loaclisation_casier.setText(_translate("MainWindow", "Localisation du casier"))
        self.label_numero_casier.setText(_translate("MainWindow", "Numéro du casier"))
        self.comboBox_localisation_casier.setItemText(0, _translate("MainWindow", "Bloc A"))
        self.comboBox_localisation_casier.setItemText(1, _translate("MainWindow", "Bloc B"))
        self.comboBox_localisation_casier.setItemText(2, _translate("MainWindow", "Bloc C"))
        self.comboBox_taille_casier.setItemText(0, _translate("MainWindow", "Petit"))
        self.comboBox_taille_casier.setItemText(1, _translate("MainWindow", "Moyen"))
        self.comboBox_taille_casier.setItemText(2, _translate("MainWindow", "Grand"))
        self.label_erreur_casier_non_disponible.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#ff0000;\">Le numéro de casier n\'est pas disponible. Entrez un nouveau numéro.</span></p></body></html>"))
        self.label_erreur_numero_casier.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#ff0000;\">Numéro de casier invalide. Entrez une lettre suivie de 4 valeurs numériques.</span></p></body></html>"))
        self.pushButton_cours.setText(_translate("MainWindow", "Cours"))
        self.label_local.setText(_translate("MainWindow", "Local"))
        self.pushButton_ajouter_local.setText(_translate("MainWindow", "Ajouter local"))
